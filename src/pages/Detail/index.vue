        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="(spuSaleAttrValue, index) in spuSaleAttrList"
              ...
              >
                ...
                <dd
                  ...
                  v-for="item in spuSaleAttrValue.spuSaleAttrValueList"
                  :key="item.id"
                  @click="
                    changeIsChecked(item, spuSaleAttrValue.spuSaleAttrValueList)
                  "
                >
...
export default {
  ...
  methods: {
    // 点击 属性值 高亮
    changeIsChecked(selectAttr, arr) {
      // 遍历 将所有的元素 去掉高亮 isChecked为0
      arr.forEach((element) => {
        element.isChecked = 0;
      });
      // 将当前 点击的元素 isChecked 修改为 1
      selectAttr.isChecked = 1;
    },
    // 表单元素修改产品个数
    changeSkuNum(event) {
      // 用户输入的文本 都 * 1 若为非数字 会出现NaN 或小于1
